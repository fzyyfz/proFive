...
<html>
	...
	<head>
		...
		<script src="${ pageContext.request.contextPath }/js/addInfor.js" type="text/javascript"></script>
				...
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								<input type="file" id="fileInp" name="touxiang" class="inputPic" allowexts="gif,jpeg,jpg,png,bmp" accept="image/*">
						...
						<!--个人信息 -->
						<div class="info-main">
							<form id="inforForm" class="am-form am-form-horizontal" action="AddInformationServlet" method="post">

								<div class="am-form-group">
									<label for="user-name2" class="am-form-label">昵称</label>
									<div class="am-form-content">
										<input type="text" id="user-name2" name="nickname" placeholder="nickname">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" name="username" value=${name}>
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" placeholder="telephonenumber" value="" name="telephonenumber" type="tel">
									</div>
								</div>
								<div class="am-form-group">
									<label for="user-email" class="am-form-label">电子邮件</label>
									<div class="am-form-content">
										<input id="user-email" placeholder="Email" value="" name="email" type="email">
								...
								<div class="info-btn">
									<div class="am-btn am-btn-danger" id="inSubmit">保存修改</div>
								</div>

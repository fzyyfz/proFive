...
<body>
	...
	<div class="login-boxtitle">
		<a
			href="${ pageContext.request.contextPath }/PageServlet?method=homeUI"><img
			alt="logo"
			...
			<div class="login-box">
				...
				<div class="login-links">
					<label for="remember-me"><input id="remember-me"
						...
						href="${ pageContext.request.contextPath }/home/HomePageServlet?method=registUI" class="zcnext am-fr am-btn-default">注册</a> <br />
				</div>

				...
				<div class="am-tabs" id="doc-my-tabs">
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-active">
							<form id="mailForm" method="post" action="${ pageContext.request.contextPath }/home/UserServlet">
								...
								<div class="user-pass">
									<label for="password"><i class="am-icon-lock"></i></label> <input
										type="password" name="oldpassword" id="password" placeholder="设置密码">
								</div>
								<div class="user-pass">
									<label for="passwordRepeat"><i class="am-icon-lock"></i></label>
									<input type="password" name="conpassword" id="passwordRepeat"
										placeholder="确认密码">
								</div>
								<%-- 验证码 --%>
	               				<div class="user-pass">
									...
									<a href="javacript:(0);"><img id="codeImg" alt="验证码" width="150px" height="40px"/></a>
	               				</div>
							...
							<div class="am-cf">
								<input type="submit" name="" id="subBut" value="注册"
						...
						<div class="am-tab-panel">
							<form method="post" id="phoneregist" action="${ pageContext.request.contextPath }/home/PhoneRegister">
								...
								<div class="user-pass">
									<label for="password"><i class="am-icon-lock"></i></label> <input
										name="ppass" type="password" placeholder="设置密码">
								</div>
								<div class="user-pass">
									<label for="passwordRepeat"><i class="am-icon-lock"></i></label>
									<input type="password" name="conppass" 
										placeholder="确认密码">
								</div>
							</form>
							<div class="login-links">
							...
							<div class="am-cf">
								<input type="submit" id="phoneBut" name="phoneBut" value="注册"
									class="am-btn am-btn-primary am-btn-sm am-fl">
							</div>

					...
					<div class="marqueen">
						...
						<div class="mod-vip">
							...
							<div class="member-logout">
								<a class="am-btn-warning btn" href="${ pageContext.request.contextPath }/PageServlet?method=loginUI" target="_blank">登录</a>
								<a class="am-btn-warning btn" href="${ pageContext.request.contextPath }/PageServlet?method=registUI" target="_blank">注册</a>
							</div>
					...
					<div class="am-g am-g-fixed recommendation">
						...
						<div class="am-u-sm-4 am-u-lg-3 ">
							...
							<div class="recommendationMain one">
								<a href="${ pageContext.request.contextPath }/home/HomePageServlet?method=introductionUI"><img src="${ pageContext.request.contextPath }/images/tj.png "></img></a>
							</div>
						</div>						
						<div class="am-u-sm-4 am-u-lg-3 ">
							<div class="info ">
			...
			<div id="sidebar">
				<div id="wrap">
					...
					<div id="shopCart " class="item ">
						<a href="${ pageContext.request.contextPath }/PageServlet?method=shopcartUI">
					...
					<div id="brand " class="item ">
						<a href="${ pageContext.request.contextPath }/PageServlet?method=collectionUI">
